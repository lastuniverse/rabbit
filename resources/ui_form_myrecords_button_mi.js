const config = {
    ...
    // имя компонента
    name: 'UI_FORM_MYRECORDS_BUTTON_MI',
    ...
    presets: [
        {
            name: 'active',
            params: [
                { time: 1, name: 'animate_reset', frameName: 'login_button_active', loop: 1},
            ]
        },
        {
            name: 'hover',
            params: [
                { time: 1, name: 'animate_reset', frameName: 'login_button_hover', loop: 1},
            ]
        },
        {
            name: 'press',
            params: [
                { time: 1, name: 'animate_reset', frameName: 'login_button_press', loop: 1 },
            ]
        },
