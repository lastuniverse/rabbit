const config = {
    ...
    // имя компонента
    name: 'UI_FORM_MYRECORDS_BUTTON_LEADBOARD',
    ...
    layers: [
        {
            ...
            frameName: 'leadboard_button_active',
    ...
    presets: [
        {
            name: 'active',
            params: [
                { time: 1, name: 'animate_reset', frameName: 'leadboard_button_active', loop: 1},
            ]
        },
        {
            name: 'hover',
            params: [
                { time: 1, name: 'animate_reset', frameName: 'leadboard_button_hover', loop: 1},
            ]
        },
        {
            name: 'press',
            params: [
                { time: 1, name: 'animate_reset', frameName: 'leadboard_button_press', loop: 1 },
            ]
        },
    ...
    on: [

        {
            ...
            listener: function() {
                ...
                // this.sounds['sound_button_press'].play();
        ...
        },
        {
            ...
            listener: function() {
                ...
                this.game.emit('ui.open.leadboard');
