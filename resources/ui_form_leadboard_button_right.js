const config = {
    ...
    // имя компонента
    name: 'UI_FORM_LEADBOARD_BUTTON_RIGHT',
    ...
    layers: [
        {
            ...
            // уникальное название слоя (используется для установки событий ввода)
            layerName: 'button',
    ...
    presets: [
        {
            name: 'active',
            params: [
                { time: 1, name: 'animate_reset', frameName: 'arrow_btn_active', loop: 1},
            ]
        },
        {
            name: 'hover',
            params: [
                { time: 1, name: 'animate_reset', frameName: 'arrow_btn_hover', loop: 1},
            ]
        },
        {
            name: 'press',
            params: [
                { time: 1, name: 'animate_reset', frameName: 'arrow_btn_press', loop: 1 },
            ]
        },
    ...
    on: [
        ...
        },
        {
            ...
            listener: function() {
                ...
                this.game.emit('ui.open.leadboard', {turn: 'right'});                
            }
        },
        {
            name: 'over',
